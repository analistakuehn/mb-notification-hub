    ...
    PublishedReadCache cache) : IPublishedCatalog
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await cache.ReadPointerAsync(
            PublishedPointerKeys.Template(app, key),
            () => FindTemplateFromStoreAsync(app, key, cancellationToken));
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await cache.ReadPointerAsync(
            PublishedPointerKeys.ClassPolicy(app, policyClass),
            () => FindClassPolicyFromStoreAsync(app, policyClass, cancellationToken));
    }
