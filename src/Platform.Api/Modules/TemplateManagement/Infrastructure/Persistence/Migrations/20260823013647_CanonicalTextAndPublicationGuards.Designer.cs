...
namespace NotificationHub.Api.Modules.TemplateManagement.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260823013647_CanonicalTextAndPublicationGuards")]
    partial class CanonicalTextAndPublicationGuards
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NotificationHub.Api.Modules.TemplateManagement.Domain.ClassPolicyVersion", b =>
                {
                    b.Property<string>("Application")
                        .HasMaxLength(100)
                        .HasColumnType("character varying(100)")
                    ...
                    b.HasKey("Application", "Class", "Version");
                    ...
                    b.HasIndex(new[] { "Application", "Class" }, "ux_class_policy_version_single_published")
                        .IsUnique()
                        .HasDatabaseName("ux_class_policy_version_single_published")
                        .HasFilter("status = 'published'");

                    b.ToTable("class_policy_version", "templatemanagement");
                });
            ...
            modelBuilder.Entity("NotificationHub.Api.Modules.TemplateManagement.Domain.LayoutVersion", b =>
                {
                    ...
                    b.HasIndex(new[] { "_layoutKey" }, "ux_layout_version_single_published")
                        .IsUnique()
            ...
            modelBuilder.Entity("NotificationHub.Api.Modules.TemplateManagement.Domain.TemplateVersion", b =>
                {
                    ...
                    b.HasIndex(new[] { "_templateKey" }, "ux_template_version_single_published")
                        .IsUnique()
