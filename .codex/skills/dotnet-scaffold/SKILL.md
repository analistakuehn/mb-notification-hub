...
obeys `./.codex/araia/shared/foundation-slice-contract.md`.
...
`LICENSE`, `AGENTS.md`, `AGENTS.md`, `.github/PULL_REQUEST_TEMPLATE.md`, and
unrelated existing content under `.araia/`, `.codex/`, `.codex/`, or `docs/`.
...
`./.codex/araia/shared/auto-clarity-protocol.md`, the uncertainty rules from
`./.codex/araia/shared/agent-uncertainty-protocol.md`, and the retry rules
from `./.codex/araia/shared/retry-protocol.md`. Append every trigger-driven
...
4. Resolve `GENERATOR` as `scripts/scaffold.py` inside the active skill. If only
   ...
   `./.codex/araia/adapters/dotnet/skills/dotnet-scaffold/scripts/scaffold.py`.
