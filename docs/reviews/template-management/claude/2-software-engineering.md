...
|---|---|---|---|
| `ENG-001` | `HIGH` | **PENDENTE** | O slice de preview reimplementa o renderizador publicado e já divergiu... |
...
| **estado** | **PENDENTE** |
| nota de estado | O slice de preview segue reimplementando o renderizador. Não tratado: é o componente do renderizador publicado, ainda não abordado. Continua sendo a divergência de maior consequência da lente, porque o autor confere uma mensagem e a produção envia outra. |
