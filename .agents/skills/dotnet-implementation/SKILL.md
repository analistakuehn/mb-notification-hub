...
`./.agents/araia/shared/implementation-evidence-contract.md` and
`./.agents/araia/shared/implementation-strategy-selection.md`. For
`--candidate-only`, also load
`./.agents/araia/shared/implementation-candidate-mode.md`,
`./.agents/araia/shared/implementation-approval-policy.md`, and
`./.agents/araia/shared/progress-tracking.md`. The parent
...
`./.agents/araia/adapters/dotnet/skills/dotnet-implementation/flows/adaptive-task-loop.md`: preserve the
...
1. Read `./.agents/araia/adapters/dotnet/code-style.md`,
   `./.agents/araia/shared/no-spec-refs-in-implementation.md`, the Stack
...
3. Resolve conditional capability needs before writes. Load
   `./.agents/araia/adapters/dotnet/references/specialties/data.md` plus
