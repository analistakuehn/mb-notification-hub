...
Load `./.agents/araia/shared/implementation-validation-pyramid.md` before
selecting or executing a sensor.
Load `./.agents/araia/shared/risk-based-implementation-evaluation.md` before
deciding whether the completed Task requires an isolated challenge.
Load `./.agents/araia/shared/test-tautology-rules.md` and
`./.agents/araia/shared/refactoring-triggers.md` before promoting an oracle
...
`loop_health` counters from `./.agents/araia/shared/progress-tracking.md`.
