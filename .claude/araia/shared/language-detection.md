...
When language is `pt-BR`, also apply `./.claude/araia/shared/ptbr-generation-rules.md` during writing. Headline constraints:
...
When language is `en`, also apply `./.claude/araia/shared/en-generation-rules.md` during writing. Headline constraints: imperative; active voice; no hedging or filler; Oxford comma.
