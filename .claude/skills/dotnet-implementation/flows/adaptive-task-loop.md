...
Load `./.claude/araia/shared/implementation-validation-pyramid.md` before
selecting or executing a sensor.
Load `./.claude/araia/shared/risk-based-implementation-evaluation.md` before
deciding whether the completed Task requires an isolated challenge.
Load `./.claude/araia/shared/test-tautology-rules.md` and
`./.claude/araia/shared/refactoring-triggers.md` before promoting an oracle
...
`loop_health` counters from `./.claude/araia/shared/progress-tracking.md`.
