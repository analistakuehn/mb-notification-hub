...
The profile schema and consumer protocol are documented at [`./.claude/araia/adapters/dotnet/references/stack-profile-protocol.md`](./.claude/araia/adapters/dotnet/references/stack-profile-protocol.md). When in doubt about field semantics, defer to the protocol.
...
Write to `.araia/stack-profile.yaml` at the project root with this YAML structure (mirrors [`./.claude/araia/adapters/dotnet/adapter.md`](./.claude/araia/adapters/dotnet/adapter.md) Stack Profile artifact):
